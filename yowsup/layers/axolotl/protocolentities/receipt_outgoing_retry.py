...
class RetryOutgoingReceiptProtocolEntity(OutgoingReceiptProtocolEntity):
    ...
    def toProtocolTreeNode(self):
        ...
        node.addChild(retry)
        registration = ProtocolTreeNode("registration",
                                        data=ResultGetKeysIqProtocolEntity._intToBytes(self.localRegistrationId))
    ...
    def fromProtocolTreeNode(node):
        ...
        entity.setRetryData(ResultGetKeysIqProtocolEntity._bytesToInt(node.getChild("registration").data),
                            retryNode["v"], retryNode["count"], retryNode["t"])
