...
class IncomingReceiptProtocolEntity(ReceiptProtocolEntity):
    """
    delivered:
    <receipt to="xxx@s.whatsapp.net" id="1415389947-15"></receipt>

    read
    <receipt to="xxx@s.whatsapp.net" id="1415389947-15" type="read"></receipt>

    delivered to participant in group:
    <receipt participant="xxx@s.whatsapp.net" from="yyy@g.us" id="1431204051-9" t="1431204094"></receipt>

    read by participant in group:
    <receipt participant="xxx@s.whatsapp.net" t="1431204235" from="yyy@g.us" id="1431204051-9" type="read"></receipt>

    multiple items:
    <receipt type="read" from="xxx@s.whatsapp.net" id="1431364583-191" t="1431365553">
        <list>
    ...
    <receipt participant="xxx@s.whatsapp.net" t="1431330533" from="yyy@g.us" id="1431330385-323" type="read">
        <list>
