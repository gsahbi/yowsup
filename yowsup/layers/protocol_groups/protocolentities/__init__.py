...
from .notification_groups_promote import PromoteGroupsNotificationProtocolEntity
from .notification_groups_demote import DemoteGroupsNotificationProtocolEntity
