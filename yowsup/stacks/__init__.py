...
YOWSUP_PROTOCOL_LAYERS_FULL = (YowGroupsProtocolLayer, YowPrivacyProtocolLayer, YowProfilesProtocolLayer,
                               YowCallsProtocolLayer) + YOWSUP_PROTOCOL_LAYERS_BASIC

YOWSUP_FULL_STACK = (YOWSUP_PROTOCOL_LAYERS_FULL,) + YOWSUP_CORE_LAYERS
