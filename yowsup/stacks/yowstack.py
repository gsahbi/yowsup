...
class YowStackBuilder(object):
    ...
    @staticmethod
    def getDefaultLayers(axolotl=False, groups=True, privacy=True, profiles=True):
        coreLayers = YowStackBuilder.getCoreLayers()
        protocolLayers = YowStackBuilder.getProtocolLayers(groups=groups, privacy=privacy,
                                                           profiles=profiles)
    ...
    @staticmethod
    def getDefaultStack(layer=None, axolotl=False, groups=True, privacy=True, profiles=True):
        """
        ...
        allLayers = YowStackBuilder.getDefaultLayers(axolotl, groups=groups, privacy=privacy,
                                                     profiles=profiles)
        if layer:
    ...
    @staticmethod
    def getProtocolLayers(groups=True, privacy=True, profiles=True):
